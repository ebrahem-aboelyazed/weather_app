...
abstract class $CityCopyWith<$Res> {
  ...
  $Res call({int id, String name, Coord? coord});
...
class _$_City implements _City {
  const _$_City({this.id = 0, this.name = '0', this.coord});
...
abstract class _City implements City {
  const factory _City({final int id, final String name, final Coord? coord}) =
      _$_City;
